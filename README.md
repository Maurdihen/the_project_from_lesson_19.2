...
`https://github.com/skypro-008/lesson19-and-tests.git`
...
- part1/simple_print
- part1/simple_off
- part1/simple_wrapper
- part1/jwt_token_generation
- part1/jwt_token_cheking
- part1/jwt_headers
- part1/jwt_auth
- part1/jwt_roles
...
- part2/passowrd_hashing
- part2/password_check
- part2/refresh
- part2/auth_view
